...
public class Employee {
    ...
    public Employee(int id, String fname, String lname, float salary, int age, String department, String address, String date_of_birth, String gender, String education, String experience, String contract_start, String contract_end, String nationality, String mother_language, String other_language) {
        super();
        this.id = id;
        this.fname = fname;
        this.lname = lname;
